                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="all-form-element-inner">
                                            @if(empty($company->id))
                                                <form method="post" action="{{route('company.insert')}}" enctype="multipart/form-data">
                                                    {{csrf_field()}}
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                ...
                                                                <span class="text-danger"> <b>{{ $errors->first('company_name') }}</b></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                ...
                                                                <span class="text-danger"> <b>{{ $errors->first('contact_person') }}</b></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                ...
                                                                <span class="text-danger"> <b>{{ $errors->first('email_address') }}</b></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <textarea id="w3mission" name="address" class="form-control"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                ...
                                                <form method="post" action="{{route('company.update')}}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="number" name="contact_person" value="{{$company->contact_person}}" class="form-control" />
                                                                <span class="text-danger"> <b>{{ $errors->first('contact_person') }}</b></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="email" name="email_address" value="{{$company->email_address}}" class="form-control" />
                                                                <span class="text-danger"> <b>{{ $errors->first('email_address') }}</b></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="number" name="mobile_no" value="{{$company->mobile_no}}" class="form-control" />
                                                                <span class="text-danger"> <b>{{ $errors->first('mobile_no') }}</b></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <img height="100px" width="100px" src="{{url("public/sliderImage/".$company->image)}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <textarea id="w3mission" name="address" class="form-control">{{$company->address}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
