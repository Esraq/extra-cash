                                        ...
                                        <div class="all-form-element-inner">
                                            <form method="post" action="{{route('restaurant.update')}}" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label class="login2 pull-right pull-right-pro">Logo Image</label>
                                                        </div>
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <img height="100px" width="100px" src="{{url("public/logo/".$restaurant->imageLink)}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <div class="form-select-list">
                                                                <select id="status" name="status" class="form-control custom-select-value">
