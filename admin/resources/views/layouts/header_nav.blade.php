                                    ...
                                    <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                            ...
                                            <div role="menu" class="author-message-top dropdown-menu animated zoomIn">
                                                ...
                                                <ul class="message-menu">
                                                    <li>
                                                        <a href="#">
                                                            <div class="message-img">
                                                                <img src="{{url('public/backend/img/contact/1.jpg')}}" alt="">
                                                            </div>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="message-img">
                                                                <img src="{{url('public/backend/img/contact/4.jpg')}}" alt="">
                                                            </div>
                                                            <div class="message-content">
                                                                <span class="message-date">16 Sept</span>
                                                                <h2>Sulaiman din</h2>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="message-img">
                                                                <img src="{{url('public/backend/img/contact/3.jpg')}}" alt="">
                                                            </div>
                                                            <div class="message-content">
                                                                <span class="message-date">16 Sept</span>
                                                                <h2>Victor Jara</h2>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="message-img">
                                                                <img src="{{url('public/backend/img/contact/2.jpg')}}" alt="">
                                                            </div>
                                                            <div class="message-content">
                                                                <span class="message-date">16 Sept</span>
                                                                <h2>Victor Jara</h2>
                                        ...
                                        <li class="nav-item">
                                            <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                ...
                                                <span class="admin-name">Supper Admin</span>
                                            ...
                                            <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                ...
                                                <li><a href="{{ route('logout') }}"><span class="fa fa-lock author-log-ic"></span>Log Out</a>
                                                </li>
                                            </ul>
                                        </li>
